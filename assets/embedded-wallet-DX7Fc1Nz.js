import{A as e,B as t,C as n,H as r,P as i,Y as a,_ as o,g as s,i as ee,j as c,l as te,ot as l,r as u,t as d,v as f,y as p,z as m}from"./ModalController-CB7tMQEb.js";import{C as h,b as g,c as _,d as v,g as y,o as b,p as x,s as S,v as C}from"./wui-text-DD3aOHXg.js";import{t as w}from"./NavigationUtil-_Ivi2WhW.js";import{t as T}from"./if-defined-vwBm-WaP.js";import"./wui-image-BVFNYhyh.js";import"./wui-loading-spinner-Dxvoy9gn.js";import"./wui-icon-pv6cpAFQ.js";import"./wui-link-BvEGu5k4.js";import{t as E}from"./wui-tag-CfosRBkR.js";import"./wui-icon-box-CKOfFYtz.js";import{n as D,t as O}from"./ref-C81Gb4pB.js";import"./wui-input-text-DCog3ldy.js";import{t as k}from"./index-BxUCW20K.js";var A=h`
  div {
    width: 100%;
  }
...
`,L=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},ne={sm:`md-regular`,md:`lg-regular`,lg:`lg-regular`},R={success:`sealCheck`,error:`warning`,warning:`exclamationCircle`},z=class extends C{constructor(){super(...arguments),this.type=`success`,this.size=`md`,this.imageSrc=void 0,this.disabled=!1,this.href=``,this.text=void 0}render(){return g`
    ...
    `}isV6(){return(i.get(`dapp_smart_account_version`)||`v6`)===`v6`}toggleSmartAccountVersion(){i.set(`dapp_smart_account_version`,this.isV6()?`v7`:`v6`),typeof window<`u`&&window?.location?.reload()}togglePreferredAccountTypeTemplate(){let e=this.network?.chainNamespace,t=u.checkIfSmartAccountEnabled(),n=o.getConnectorId(e);return!o.getAuthConnector()||n!==l.CONNECTOR_ID.AUTH||!t?null:(this.switched||(this.text=s(e)===m.ACCOUNT_TYPES.SMART_ACCOUNT?`Switch to your EOA`:`Switch to your Smart Account`),g`
      <wui-list-item
        icon="swapHorizontal"
        ?rounded=${!0}
        ?chevron=${!0}
...
`,Z=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Q=class extends C{constructor(){super(),this.formRef=O(),this.usubscribe=[],this.name=``,this.error=``,this.loading=k.state.loading,this.suggestions=k.state.suggestions,this.profileName=u.getAccountData()?.profileName,this.onDebouncedNameInputChange=t.debounce(e=>{e.length<4?this.error=`Name must be at least 4 characters long`:E.isValidReownName(e)?(this.error=``,k.getSuggestions(e)):this.error=`The value is not a valid username`}),this.usubscribe.push(k.subscribe(e=>{this.suggestions=e.suggestions,this.loading=e.loading}),u.subscribeChainProp(`accountState`,e=>{this.profileName=e?.profileName,e?.profileName&&(this.error=`You already own a name`)}))}firstUpdated(){this.formRef.value?.addEventListener(`keydown`,this.onEnterKey.bind(this))}disconnectedCallback(){super.disconnectedCallback(),this.usubscribe.forEach(e=>e()),this.formRef.value?.removeEventListener(`keydown`,this.onEnterKey.bind(this))}render(){return g`
    ...
    `}onNameInputChange(e){let t=E.validateReownName(e.detail||``);this.name=t,this.onDebouncedNameInputChange(t)}onKeyDown(e){e.key.length===1&&!E.isValidReownName(e.key)&&e.preventDefault()}templateSuggestions(){return!this.name||this.name.length<4||this.error?null:g`<wui-flex flexDirection="column" gap="1" alignItems="center">
