import{G as e,J as t,K as n,O as r,t as i,y as a}from"./ModalController-CB7tMQEb.js";import{C as o,b as s,c,g as l,o as u,s as d,v as f}from"./wui-text-DD3aOHXg.js";import"./wui-icon-pv6cpAFQ.js";var p=n({message:``,open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:`shade`}),m=r({state:p,subscribe(e){return t(p,()=>e(p))},subscribeKey(t,n){return e(p,t,n)},showTooltip({message:e,triggerRect:t,variant:n}){p.open=!0,p.message=e,p.triggerRect=t,p.variant=n},hide(){p.open=!1,p.message=``,p.triggerRect={width:0,height:0,top:0,left:0}}}),h=o`
  :host {
    width: 100%;
    display: block;
  }
