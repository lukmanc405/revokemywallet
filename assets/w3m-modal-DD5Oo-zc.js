import{A as e,C as t,E as n,S as r,T as i,_ as a,j as o,l as s,r as c,s as l,t as u,v as ee,y as d}from"./ModalController-CB7tMQEb.js";import{C as te,_ as f,b as p,c as m,d as ne,f as re,g as h,o as g,p as _,s as v,u as y,v as b}from"./wui-text-DD3aOHXg.js";import{r as x}from"./wui-list-wallet-hEYvV0GK.js";import{t as ie}from"./SwapController-BfdnFYT9.js";import{t as S}from"./AlertController-DZZY7SSE.js";import"./w3m-tooltip-CW5l0dMp.js";import{t as C}from"./if-defined-vwBm-WaP.js";import"./wui-image-BVFNYhyh.js";import"./wui-loading-spinner-Dxvoy9gn.js";import"./wui-icon-box-C_PrOtKG.js";import"./wui-icon-pv6cpAFQ.js";import{t as w}from"./ConstantsUtil-DqF0P55S.js";import{t as T}from"./wui-tag-CfosRBkR.js";import"./index-BxUCW20K.js";import{n as E}from"./exports-ChQi4F1i.js";var D={isUnsupportedChainView(){return d.state.view===`UnsupportedChain`||d.state.view===`SwitchNetwork`&&d.state.history.includes(`UnsupportedChain`)},async safeClose(){if(this.isUnsupportedChainView()){u.shake();return}if(await x.isSIWXCloseDisabled()){u.shake();return}(d.state.view===`DataCapture`||d.state.view===`DataCaptureOtpConfirm`)&&s.disconnect(),u.close()}},ae=h`
  :host {
    display: block;
